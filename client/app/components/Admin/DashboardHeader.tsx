"use client";
import { ThemesSwitcher } from "@/app/utils/ThemeSwitcher";
// import {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0 z-[9999999]">
      ...
      >
        ...
        <span className="absolute -top-2 -right-2 bg-[#5b6fe6] rounded-full w-[20px] h-[20px] text-[12px] flex items-center justify-center text-white">
          ...
          <div
              ...
              >
                <div className="w-full flex items-center justify-between p-2">
                  <p className="text-black dark:text-white">Nueva pregunta en: Curso - EXANI II</p>
                  <p
                ...
                <p className="px-2 text-black dark:text-white">
                  ¡Hola! ¿Podrían ayudarme con una duda que tengo sobre el tema? 
                </p>
