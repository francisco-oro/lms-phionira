   ...
   <>
      ...
      <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
        ...
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] h-[50px] bg-transparent relative">
          ...
          />
          <div className="absolute flex items-center justify-center w-[50px] cursor-pointer h-[50px] right-0 top-0 bg-[#d0bcd5] rounded-r-[5px]"
          >
        ...
        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
          ...
          <p className="font-Josefin dark:text-[#edfff4] text-[#000000b3] 1000px:pl-3 text-[18px] font-[600]">
            Acompañamiento psicológico disponible en nuestros cursos de preparación al examen de admisión{" "}
            <Link
              href="/courses"
              className="dark:text-[#6667ab] text-[#388697]"
            >
              Ver cursos 
            </Link>{" "}
          </p>
